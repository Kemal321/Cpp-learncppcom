...
namespace estate_executor{
    ...
    int assemble_code(){
        int bluee =( garcia::blue::code_fragment() + khan::blue::code_fragment() + zhang::blue::code_fragment()); 
        int redd = (garcia::red::code_fragment() + khan::red::code_fragment() + zhang::red::code_fragment());
        return (bluee * redd); 
    }
}